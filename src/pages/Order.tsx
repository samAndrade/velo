              ...
              <section className="bg-card rounded-lg p-6 shadow-elegant">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    {errors.lastname && <p className="text-sm text-destructive" data-testid="checkout-lastname-error">{errors.lastname}</p>}
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    {errors.document && <p className="text-sm text-destructive" data-testid="checkout-document-error">{errors.document}</p>}
                  </div>
                  <div className="space-y-2">
